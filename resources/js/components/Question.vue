                ...
                <div class="card-body" v-else>
                    <div class="card-title">
                        <div class="d-flex align-items-center">
                            <h1>{{ title }}</h1>
                            <div class="ml-auto">
                                <a href="/stock_overflow/public/questions" class="btn btn-outline-secondary">Back to all Questions</a>
                            </div>
                        </div>                        
                    </div>
...
export default {
    ...
    computed: {
        ...
        endpoint(){
            return `/stock_overflow/public/questions/${this.id}`;
        }
    },
    methods: {
        setEditCache(){
        ...
        delete(){
            axios.delete(this.endpoint)
                ...
                setTimeout(() => {
                    window.location.href = "/stock_overflow/public/questions";
                }, 3000);
        }
    }
}
